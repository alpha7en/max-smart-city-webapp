...
| 7 | Выбрать тип и адрес; если номер на фото не виден — «Ввести номер», например `18-452178` | «Смотрим на фото…», значение с фото (без `meter-reader` — с пометкой демо-распознавания), кнопки «Отправить», «Исправить», «Переснять», «Отмена» |
