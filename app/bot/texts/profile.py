...
ASK_ADDRESS = "Напишите новый адрес одной строкой: город, улица, дом, квартира.\n\nНапример: Москва, Арбат 47к1, кв. 32"
...
DEMO_GRANTED = "Доступ открыт (в демо мы одобрили за собственника). Можно передавать показания."
...
ACCESS_CLAIMED = (
    ...
    "Права по адресам в демо-версии смоделированы."
)
