...
NAME_ERRORS = {
    ...
    "digits": f"В имени не должно быть цифр. Напишите, {NAME_EXAMPLE}",
    "chars": f"В имени лишние символы — можно буквы, дефис и апостроф. Напишите, {NAME_EXAMPLE}",
...
ADDRESS_EXAMPLE = "Например: Москва, Арбат 47к1, кв. 32"
...
ADDRESS_NOT_FOUND_ASIS = (
    "Не нашли такой адрес в справочнике ФИАС. Проверьте улицу и номер дома.\n\n"
    "Мы поняли так: {address}\n\n"
    "Можно сохранить адрес как есть — без сверки с ФИАС."
)
ADDRESS_ONE = "Мы поняли так:\n{address}\n\nВерно?"
ADDRESS_MANY = "Нашли несколько вариантов. Выберите свой:"
LOCAL_NOTE = "Адрес не сверен с ФИАС (демо-режим без ключа DaData)."
ASIS_NOTE = "Адрес не сверен с ФИАС — сохраним, как вы написали."
FLAT_WARNING = "По данным ФИАС в этом доме {count} кв. — проверьте номер квартиры."
...
SAVED = "Записали:\n\n{name}\n{phone}\n{address}"
DONE = "Готово, вы зарегистрированы. Теперь достаточно прислать фото счётчика."
DONE_SHORT = "Готово, вы зарегистрированы."
DONE_PHOTO = "Готово, вы зарегистрированы. Теперь разберём фото, которое вы прислали."
DONE_PHOTO_EXPIRED = (
    "Готово, вы зарегистрированы. Фото, которое вы присылали, мы уже не храним — пришлите его ещё раз."
)
