...
SUB_EXPIRED = "Прошлая подача прервалась — начнём заново."
PROFILE_EXPIRED = "Изменение профиля прервалось — начнём заново."
...
PROFILE_CANCELLED_BY_USER = "Изменения профиля отменили."
